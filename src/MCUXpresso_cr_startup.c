...
//*****************************************************************************
// Patch the AEABI integer divide functions to use MCU's ROM divide library.
// Two global variables are declared here for use by aeabi_romdiv_patch.s.
// They will point to the ROM_DIV_API sidiv and uidiv functions, respectively.
//*****************************************************************************
...
void (* const g_pfnVectors[])(void) = {
    ...
    0,                                       // Reserved for FAIM controller
