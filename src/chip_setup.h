...
#define DBGUART 1                  // MHH:12/12/2022. So SIG100 uart can be zero for IAP calls (flash programming)

//#define DBGBAUDRATE 9600           // Choose the baud rate for the debug UART
#define DBGBAUDRATE 19200           // Choose the baud rate for the debug UART
...
#else
  #define DBGTXPIN P0_27           // Use with USB-to-RS232 break-out cable (choose your own favorite TxD pin)
  #define DBGRXPIN P0_26           // Use with USB-to-RS232 break-out cable (choose your own favorite RxD pin)
#endif
