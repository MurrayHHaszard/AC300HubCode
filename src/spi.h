...
#define SPI_MRAM_CS_PIN		P1_7
#define SPI_FLASH_CS_PIN	P0_21

#ifdef MH_OLD_SPI
#define SPI_MRAM_CS1()    (LPC_GPIO_PORT->SET[1] = 1<<(SPI_MRAM_CS_PIN-32))
#define SPI_MRAM_CS0()    (LPC_GPIO_PORT->CLR[1] = 1<<(SPI_MRAM_CS_PIN-32))

#define SPI_FLASH127_CS1()    (LPC_GPIO_PORT->SET[0] = 1<<(SPI_FLASH_CS_PIN))
#define SPI_FLASH127_CS0()    (LPC_GPIO_PORT->CLR[0] = 1<<(SPI_FLASH_CS_PIN))
#endif

#define SPI_ACCEL_CS_PIN	P0_9

//#define SPI_ACCEL_CS1()    (LPC_GPIO_PORT->SET[0] = 1<<(SPI_ACCEL_CS_PIN))
//#define SPI_ACCEL_CS0()    (LPC_GPIO_PORT->CLR[0] = 1<<(SPI_ACCEL_CS_PIN))
...
//#define LPC_SPI0BAUDRate            1000000
//#define LPC_SPI0BAUDRate            2000000
#define LPC_SPI0BAUDRate            4000000		// MHH:05/10/2023
//#define LPC_SPI0BAUDRate            15000000
...
#define SPI_CTL_TXSSEL0_N   (1<<16)
#define SPI_CTL_TXSSEL1_N   (1<<17)
...
void SPImasterWriteOnly(int spi_num, uint8_t *WrBuf, uint32_t WrLen );
void SPImasterWriteRead(int spi_num, uint8_t *WrBuf, uint8_t *RdBuf, uint32_t WrLen );
void SPImasterReadOnly(int spi_num, uint8_t *RdBuf, uint32_t RdLen );
...
extern uint32_t SPI_command_address_size;
#endif /* lpc8xx_SPI_H_ */
